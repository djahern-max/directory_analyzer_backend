...
from app.models.document import RankedDocument, ClassificationSummary
...
class DirectoryAnalysisResponse(BaseAPIModel, TimestampMixin):
    ...
    # Main results - allow any dict structure for main_contract
    main_contract: Optional[Dict[str, Any]] = None
    ranked_documents: List[Dict[str, Any]]  # Also allow flexible structure
