...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "credits_remaining", sa.Numeric(precision=10, scale=4), nullable=True
        ),
        sa.Column(
            "total_credits_purchased", sa.Numeric(precision=10, scale=4), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column("contract_type", contracttype, nullable=True),
    ...
    op.create_index(
        op.f("ix_contracts_is_main_contract"),
        "contracts",
        ["is_main_contract"],
        unique=False,
    )
    ...
    # 5. Create contract_relationships table (depends on contracts)
    op.create_table(
    ...
    # 6. Create document_classifications table (depends on contracts)
    op.create_table(
    ...
    # 7. Create text_extractions table (depends on contracts)
    op.create_table(
        "text_extractions",
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column("contract_id", sa.UUID(), nullable=False),
        ...
        sa.Column(
            "extraction_time_seconds", sa.Numeric(precision=10, scale=3), nullable=True
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    # 8. Create analysis_results table (depends on contracts, jobs, and analysis_sessions)
    op.create_table(
        "analysis_results",
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column("contract_id", sa.UUID(), nullable=False),
    ...
    # 9. Create usage_records table (depends on users, analysis_sessions, and jobs)
    op.create_table(
        "usage_records",
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column("user_id", sa.UUID(), nullable=False),
